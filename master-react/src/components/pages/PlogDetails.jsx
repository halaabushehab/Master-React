...
const PlogDetails = () => {
  ...
  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-dark bg-opacity-50 p-4 rounded">
    <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl max-w-full overflow-hidden">مرحبًا بكم في عالم المقالات</h1>
    <p className="lead text-base sm:text-lg md:text-xl lg:text-2xl max-w-full overflow-hidden">استمتعوا بقراءة أحدث المقالات والمحتوى الحصري.</p>
  </div>
</section>
      {/* Blog Area */}
